...
{} & \specialcells{Supervisors: & Assoc.\ Prof.\ Pinhas Grossman, Dr.\ Anna Romanov,\\ & Dr.\ Arnaud Brothier\\
Topic: & Classification of Non-Unitary Near-Group Fusion Categories}
...
\item categorification and categorical representation theory, such as with respect to the category of Soergel bimodules and its module categories;
...
Mai, P.\ Y., Pereira, P.\ H., Alonso, L.\ A.\ et al., \textit{Enhancement of Electric Drive in Silicon Quantum Dots with Electric Quadrupole Spin Resonance}, Phys.\ Rev.\ Res.\ \textbf{7}, 043134 (2025).\\
\end{adjustwidth}
...
\specialcell{\Small 2025, Aug.\ 11th} & \specialcell{{\bfseries\boldmath Categorification and the Lusztig--Vogan Module}}\\
{} & \specialcell{UNSW Mathematics and Statistics Postgraduate Conference (Australia)}
\end{tabular}\\[0.75\baselineskip]
\begin{tabular}[t]{@{}p{2.75cm}|l@{}}
\specialcell{\Small 2025, Apr.\ 7th} & \specialcell{{\bfseries\boldmath The Banach--Tarski Paradox and Amenability}}\\
{} & \specialcell{UNSW Masters/PhD Student Seminar (Australia)}
\end{tabular}\\[0.75\baselineskip]
\begin{tabular}[t]{@{}p{2.75cm}|l@{}}
...
\item Proficient in C, Assembly, Magma, Sage, MATLAB/Octave, Python, Mathematica, C\texttt{++}, PHP, JavaScript and HTML5.
