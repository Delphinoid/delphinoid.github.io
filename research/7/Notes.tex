...
\end{split}
\end{align*}
\noindent However, $W_K$ must be generated by two orthogonal elements, as it is given by two commuting copies of $A_2$. Thus the only possibility is $W_K = \langle sts, (st)^3\rangle$, whence ${}^KW = \{1, s, t\}$ (in fact, we can see that this is the only viable option by symmetry).\\
