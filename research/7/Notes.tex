...
\noindent Note that we can expand and rearrange the quadratic relation as $1 = \delta_s^2 + (v - v^{-1})\delta_s$, whence by multiplying through by $\delta_s^{-1}$ we obtain $\delta_s^{-1} = \delta_s + (v - v^{-1})$.\\
