...
\noindent For a proof of this in the fiat case, see \cite[Theorem 15]{MM14}. According to \cite{MMMTZ21}, this also holds in the more general case of multifinitary bicategories, with the $\mathcal{J}$-simple quotient $\mathscr{C}_{\leq\mathcal{J}}$ being unique up to biequivalence. Moreover, if $\mathscr{C}$ is (quasi) multifiab, then the $\mathcal{J}$-simple quotient $\mathscr{C}_{\leq\mathcal{J}}$ is also (quasi) multifiab.\\
...
\end{split}
\end{align*}
\noindent This makes the classification significantly easier, as $\mathscr{S}_\mathcal{H}$ turns out to be a great deal smaller than $\mathscr{S}$.\\
