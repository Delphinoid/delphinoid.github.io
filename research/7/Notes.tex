...
\end{split}
\end{align*}
\noindent as desired. The exact same proof shows that $R \otimes_R B_t$ is indecomposable, where we instead use the generator $2\alpha_s+\alpha_t$ of $R^t$ rather than $3\alpha_s+2\alpha_t$.
\end{example}
\newpage
