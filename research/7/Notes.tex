...
$\langle s, tstst\rangle$ & $\{H, Ht, Hts\}$\\\hline
$\langle sts, tst\rangle$ & $\{H, Hs, Ht\}$\\\hline
$\langle t, ststs\rangle$ & $\{H, Hs, Hst\}$\\\hline
\end{tabular}\ .\\[0.5\linespacing]
\renewcommand{\arraystretch}{1}
\end{center}
\noindent Using the Atlas of Lie Groups and Representations software, we are able to determine that\linebreak $W_K = \langle sts, tst\rangle$, whence our right coset representatives are $\{1, s, t\}$.\\
