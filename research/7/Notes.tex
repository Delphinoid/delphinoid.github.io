...
\end{split}
\end{align*}
\noindent Where does $B_s$ come from? Well, observe that
\begin{align*}
\begin{split}
...
\textcolor{red}{Where does $B_s$ come from? Compare to $b_s$ in the Iwahori--Hecke algebra, show that $b_s = T_s + q$.}\\
