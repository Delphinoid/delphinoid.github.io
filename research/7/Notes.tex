...
\end{split}
\end{align*}
\noindent\\[-0.7\linespacing] We define $R^{W_K}$ to be the polynomials in $R$ that are invariant under action by $W_K$. By \cite[Remark 6.2.4]{LR22}, we have $W = W^\theta$ in this case. Letting ${}^KW$ be coset representatives for $W_K\backslash W$,\\[-1.2\linespacing]
\begin{align*}
\begin{split}
